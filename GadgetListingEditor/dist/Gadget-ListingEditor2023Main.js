/**
 * Listing Editor v4.0.0-alpha-10
 ...
 */
 //<nowiki>
window.__WIKIVOYAGE_LISTING_EDITOR_VERSION__ = '4.0.0-alpha-10'

'use strict';

var require$$0$1 = require('vue');
var require$$5 = require('@wikimedia/codex');
...
function requireListingEditorDialog () {
	...
	const { CdxDialog, CdxTextInput, CdxButton, CdxProgressBar } = require$$5;
            ...
            <div id="div_type" class="editor-row">
                ...
                <div>
                    <select id="input-type">
                        ...
                        <option v-if="customListingType"
                            :value="customListingType">{{ customListingType }}</option>
                    </select>
                </div>
                <div class="editor-fullwidth">
                    <span id="span-closed">
...
function requireCore () {
	...
	const { CdxTextInput, CdxTextArea, CdxTabs, CdxTab } = require$$5;
